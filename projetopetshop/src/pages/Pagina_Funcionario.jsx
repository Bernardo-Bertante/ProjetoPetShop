...
function Pagina_Funcionario() {
  ...
  const getDados = async () => {
    try {
      const resposta = await axios.get("/funcionario/all");
    ...
    <div className="pagina-agendamento">
      <nav className="navbar">
        ...
        <button
          ...
          onClick={() => navigate("/formulario-funcionario")}
        >
          Cadastrar
        </button>
      </nav>
      ...
      <section className="cards">
        {dados.length > 0 ? (
          ...
          <span className="texto-aviso">NÃO HÁ FUNCIONÁRIOS CADASTRADOS</span>
        )}
      </section>
...
export default Pagina_Funcionario;
